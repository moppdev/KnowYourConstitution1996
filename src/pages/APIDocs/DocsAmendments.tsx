...
export default function DocsAmendments()
{
    ...
    return (
        <div id="apidocs-amendments" className="pb-30 sm:pb-65 md:pb-95">
            ...
            <p className={paragraphClassString}>
                <strong>The route returns:</strong> the name of the amendment, the date it came into effect and references to the amendment.
            </p>
            ...
            <CodeSnippet lang="typescript" lines={`[
    {
        ...
        "reference": "string"
            ...
            <p className={paragraphClassString}>
                Here's an example of how to call the route:
            </p>
